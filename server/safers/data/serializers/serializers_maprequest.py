...
from safers.core.serializers import ContextVariableDefault, SwaggerCurrentUserDefault
...
class MapRequestViewSerializer(serializers.Serializer):
    ...
    ProxyFieldMapping = {
        ...
        "map_request_codes": "MapRequestCodes",
    }
    ...
    map_request_codes = serializers.ListField(
        # using a ListField b/c the proxy API adds multiple query_params to the request
        # ie: `&MapRequestCodes=1&MapRequestCodes=2` instead of `&MapRequestCodes=1,2`
        default=ContextVariableDefault("map_request_codes"),
        help_text=_(
...
class MapRequestDataTypeSerializer(serializers.ModelSerializer):
    ...
    opacity = serializers.FloatField(source="data_type.opacity")
