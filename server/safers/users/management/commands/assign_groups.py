...
class Command(BaseCommand):
    """
    Allows me to force a specified user to be members of the specified groups.
    Useful for granting admin users membership to admin groups.
    """

    help = "Assign specified user to specified groups."
