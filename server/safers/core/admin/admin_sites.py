...
from safers.core.admin.admin_utils import get_clickable_fk_list_display
...
class SiteProfileAdmin(admin.ModelAdmin):
    ...
    list_display = ("code", "get_site_for_list_display")

    @admin.display(description="SITE")
    def get_site_for_list_display(self, obj):
        admin_change_url_name = "admin:sites_site_change"
        list_display = f"<a href='{reverse(admin_change_url_name, args=[obj.site.pk])}'>{str(obj.site)}</a>"
